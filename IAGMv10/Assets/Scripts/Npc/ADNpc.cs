    ...
    public static ADNPC RandomNPC(int a, Sprite[] np)
    {
        ...
        switch (a) // 수정전 n by주현
        {
            case 0: // 여자 궁수
                ...
                adnpc.myStatInfo.agility = 30 + Mathf.Clamp(UnityEngine.Random.Range(0, (GameManager.Instance.Fame / 20)), 0, 99999999); // 10당 10씩증가
                adnpc.myStatInfo.intellect = 20 + Mathf.Clamp(UnityEngine.Random.Range(0, (GameManager.Instance.Fame / 50)), 0, 99999999); // 10당 1씩 증가
                adnpc.myStatInfo.strong = 10 + Mathf.Clamp(UnityEngine.Random.Range(0, (GameManager.Instance.Fame / 100)), 0, 99999999); // 10당 1씩 증가
                adnpc.myStatInfo.dexterity = 40 + Mathf.Clamp(UnityEngine.Random.Range(0, (GameManager.Instance.Fame / 10)), 0, 99999999); // 10당 10씩 증가
            ...
            case 1: // 여자 도적
                ...
                adnpc.myStatInfo.agility = 40 + Mathf.Clamp(UnityEngine.Random.Range(0, (GameManager.Instance.Fame / 10)), 0, 99999999); // 10당 10씩증가
                adnpc.myStatInfo.intellect = 10 + Mathf.Clamp(UnityEngine.Random.Range(0, (GameManager.Instance.Fame / 100)), 0, 99999999); // 10당 1씩 증가
                adnpc.myStatInfo.strong = 20 + Mathf.Clamp(UnityEngine.Random.Range(0, (GameManager.Instance.Fame / 50)), 0, 99999999); // 10당 1씩 증가
                adnpc.myStatInfo.dexterity = 30 + Mathf.Clamp(UnityEngine.Random.Range(0, (GameManager.Instance.Fame / 20)), 0, 99999999); // 10당 10씩 증가
            ...
            case 2: // 여자 마법사
                ...
                adnpc.myStatInfo.agility = 20 + Mathf.Clamp(UnityEngine.Random.Range(0, (GameManager.Instance.Fame / 50)), 0, 99999999); // 10당 10씩증가
                adnpc.myStatInfo.intellect = 40 + Mathf.Clamp(UnityEngine.Random.Range(0, (GameManager.Instance.Fame / 10)), 0, 99999999); // 10당 1씩 증가
                adnpc.myStatInfo.strong = 10 + Mathf.Clamp(UnityEngine.Random.Range(0, (GameManager.Instance.Fame / 100)), 0, 99999999); // 10당 1씩 증가
                adnpc.myStatInfo.dexterity = 30 + Mathf.Clamp(UnityEngine.Random.Range(0, (GameManager.Instance.Fame / 20)), 0, 99999999); // 10당 10씩 증가
            ...
            case 6: // 남자 전사
                ...
                adnpc.myStatInfo.agility = 30 + Mathf.Clamp(UnityEngine.Random.Range(0, (GameManager.Instance.Fame / 20)), 0, 99999999); // 10당 10씩증가
                adnpc.myStatInfo.intellect = 10 + Mathf.Clamp(UnityEngine.Random.Range(0, (GameManager.Instance.Fame / 100)), 0, 99999999); // 10당 1씩 증가
                adnpc.myStatInfo.strong = 40 + Mathf.Clamp(UnityEngine.Random.Range(0, (GameManager.Instance.Fame / 10)), 0, 99999999); // 10당 1씩 증가
                adnpc.myStatInfo.dexterity = 20 + Mathf.Clamp(UnityEngine.Random.Range(0, (GameManager.Instance.Fame / 50)), 0, 99999999); // 10당 10씩 증가
